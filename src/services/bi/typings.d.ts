declare namespace API {
  ...
  type BaseResponseListSimpleChartInfo_ = {
    code?: number;
    data?: SimpleChartInfo[];
    message?: string;
  };
  ...
  type BaseResponseMapStringBoolean_ = {
    code?: number;
    data?: Record<string, any>;
    message?: string;
  };

  type BaseResponseOriginalDataVO_ = {
    code?: number;
    data?: OriginalDataVO;
    message?: string;
  };
  ...
  type genChartByAIMqUsingPOSTParams = {
    chartType?: string;
    goal?: string;
    name?: string;
  };
  ...
  type getAllUnreadUsingGETParams = {
    /** current */
    current: number;
  };
