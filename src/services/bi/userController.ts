...
/** listUserVOByPage POST /api/user/searchUsers */
export async function listUserVOByPageUsingPOST(
  body: API.UserQueryRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponsePageUserVO_>('/api/user/searchUsers', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** updateMyUser POST /api/user/updateMyInfo */
export async function updateMyUserUsingPOST(
  body: API.UserUpdateMyRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseBoolean_>('/api/user/updateMyInfo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
